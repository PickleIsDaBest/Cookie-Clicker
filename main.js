...
All this code is copyright Orteil, 2013-2022.
	...
	-want to mod the game? scroll down to the "MODDING API" sectio
...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		{
			Game.Notify(loc("Cookie Clicker hack"),loc("Hello there! If you want to access the hacks hover over the Mods/Addons at the top right of your screen!")+'<div class="line"></div><a style="float:right;" onclick="Game.prefs.showBackupWarning=0;==CLOSETHIS()==">'+loc("")+'</a>',[25,7]);
		}
	...
	Game.Logic=function()
	{
		...
		if (!Game.OnAscend && Game.AscendTimer==0)
		{
			...
			if (Game.T%(Game.fps*5)==0 && Game.ObjectsById.length>0)//check some achievements and upgrades
			{
				...
				if (Game.cookiesEarned<Game.cookies) Game.Win('Itchscratcher');
